  ...
  return (
    <>
      <footer className="footer p-5 bg-footer " style={{ backgroundColor: `#1B1F27` }}>
        <div>
          <div className='mx-10 max-sm:mx-0 max-sm:py-0 flex flex-col max-sm:items-center max-sm:m-auto'>
            ...
            <p className='pt-5 md:w-72 text-justify max-sm:text-center ' style={{ color: `#9D9EA1` }}>¡Juntos podemos lograr el futuro que queremos! Sumate al cambio que el mundo necesita.</p>
          </div>
        ...
        <div className='sm:py-0 md:py-10'>
          <span className="footer-title max-sm:text-center max-sm:m-auto " style={{ color: `#9D9EA1` }}>¡No te pierdas de nada!</span>
          <div className="form-control ">
            <span className="label-text text-left max-sm:text-center " style={{ color: `#9D9EA1` }}>Suscribite a nuestro NewsLetter.</span>
            {
              Input 
              ?
              <div className='mt-5'>
      ...
      <div className='flex justify-start flex-wrap' style={{ backgroundColor: `#1B1F27` }} >
        ...
        <span className="footer-title text-left mx-10 max-sm:text-center " style={{ color: `#9D9EA1` }}>Encontranos en</span>
      ...
      <p className='w-96 text-left max-sm:text-center max-sm:py-10 md:mx-40 text-white' >¿Querés ser cliente mayorista? Comunicate con nosotros a <span className='text-red-500'>mayorista@leaf.social</span></p>
      </div>
