...
const Footer = () => {
  ...
  return (
    <>
      ...
      <p className='w-96 text-left max-sm:text-center max-sm:py-10 md:mx-44 text-white' >¿Querés ser cliente mayorista? Comunicate con nosotros a <span className='text-red-500'>mayorista@leaf.social</span></p>
      </div>
