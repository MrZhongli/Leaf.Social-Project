  ...
  return (
    <>
      <div className='absolute top-1/3  flex flex-col  ' >
        <h1 className="text-5xl font-bold text-white text-center max-sm:text-4xl text-focus-in m-auto md:w-2/3" >Transformamos desperdicios en productos innovadores.</h1>
        <p className="py-6 text-xl max-sm:text-lg max-sm:mx-3  text-white  text-center max-sm:text-md text-focus-in m-auto md:w-2/3 mt-5">Le damos una segunda vida, una segunda oportunidad a diversos materiales de excelente calidad, que al ser desechados son sumamente contaminantes y tardan más de 1.000 años en degradarse.</p>
      </div>
